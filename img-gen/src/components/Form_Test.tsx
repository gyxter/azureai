...
export function Form({ onSubmit, showLoading }: FormProps) {
    ...
    const [formData, setFormData] = useState<UserData>({ page: sizes[0].name, mood: moods[0].name, components: [], placeholderImages: '' });
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div className="col-md-4">
                <div className="mb-3">
                    ...
                    <br />
                    <select id="size" name="size" className="form-select" value={formData.page} onChange={handleSelectChange}>
                        {sizes.map((size) => (
