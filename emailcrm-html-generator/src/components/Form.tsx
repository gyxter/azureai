...
export function Form({ showLoading, handleSubmit }: FormProps) {
    ...
    function handleFormSubmit() {
        ...
        let assembledPrompt1 = "Use HTML source below and generate sample html content within the 3rd <table>:" +       
        `---<!DOCTYPE html>
                ...
                <tr>
                    ...
                    <table role="presentation" style="width:94%;max-width:600px;border:none;border-spacing:0;text-align:left;font-family:Arial,sans-serif;font-size:16px;line-height:22px;color:#363636;">
                        ...
                        <td style="padding:40px 30px 30px 30px;text-align:center;font-size:24px;font-weight:bold;">
                            <a href="http://www.example.com/" style="text-decoration:none;"><img src="${radioOption.valueOf() !== 'yes' ? + 'Generate random image for logo here' : 'https://assets.codepen.io/210284/logo.png' }" width="165" alt="Logo" style="width:165px;max-width:80%;height:auto;border:none;text-decoration:none;color:#ffffff;"></a>
                        </td>
                        </tr>
                        <tr>
            ...
            /* "2. Add a header with subject." +
            "3. Add a pre-header." +
            "4. Add lorem ipsum content with placeholder images." +
            "5. Add some column CTA." +
            "6. Add a footer." +
            "7. HTML code should render properly in outlook, gmail, yahoo, IOS mail clients." */
        ...
        <div className="row">
            ...
            <div className="col-md-6">
                ...
                <label className="form-label" htmlFor="plImages">
                    ...
                    <br />
                    {placeholderOpts.map(({ view: title, value: option }: any) => {
                        return (
                            <>
                            <input
                                type="radio"
